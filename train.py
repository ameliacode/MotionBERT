...
from lib.data.datareader_ap3d import DataReaderH36M

# from lib.data.datareader_h36m import DataReaderH36M
from lib.data.dataset_motion_2d import InstaVDataset2D, PoseTrackDataset2D
...
def train_with_config(args, opts):
    ...
    if not opts.evaluate:
        ...
        if args.train_2d:
            print(
                "INFO: Training on {}(3D)+{}(2D) batches".format(
                    len(train_loader_3d),
